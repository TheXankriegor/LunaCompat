...
namespace LunaCompat.Mods.KerbalInventorySystem;

[UsedImplicitly]
internal class KisIntegration : ClientModIntegration
{
    #region Constructors

    public KisIntegration(ILogger logger, IModSettingsProvider settingsProvider)
    ...
    public override void Setup()
    {
        ...
        LunaCompat.HarmonyInstance.Patch(AccessTools.Method(kisShared, "CreatePart", [
            typeof(ConfigNode), typeof(Vector3), typeof(Quaternion), typeof(Part), typeof(Part), typeof(string), typeof(AttachNode), onPartReady,
            typeof(bool)
        ]), postfix: new HarmonyMethod(typeof(KisIntegration), nameof(PostfixCreatePart)));
    }
